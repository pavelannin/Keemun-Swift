...
struct ___VARIABLE_FeatureName___FeatureView: View {
    @ObservedObject private var connector: KeemunConnector<___VARIABLE_FeatureName___Feature.ViewState, ___VARIABLE_FeatureName___Feature.ExternalMsg>

    init(_ connector: KeemunConnector<___VARIABLE_FeatureName___Feature.ViewState, ___VARIABLE_FeatureName___Feature.ExternalMsg>) {
